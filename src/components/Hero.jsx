...
import FlipWords from "@/lib/flipwords";

const Hero = () => {
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-6 pb-16 text-center lg:pt-14">
      <h1 className="mx-auto max-w-4xl text-5xl font-extrabold tracking-tight text-white sm:text-7xl">
        <span className="inline-block">
          ...
          <span className="relative whitespace-nowrap text-purple-500">
            ...
            <span className="relative">&nbsp;Mehak</span>
          </span>
        </span>
      </h1>

      <h1 className="mx-auto max-w-4xl text-5xl pt-7 font-extrabold tracking-tight relative bg-clip-text text-transparent bg-no-repeat bg-gradient-to-r from-purple-500 via-violet-500 to-pink-500 sm:text-7xl">
        <span className="inline-block">
          <span className="relative whitespace-nowrap text-purple-500">
